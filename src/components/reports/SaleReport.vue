...
const fields = [
  ...
  { key: "products_purchased", label: "Products Purchased", _style: "width:50%" },
  ...
  { key: "cost_of_goods_sold", label: "Cost Of Goods Sold", _style: "width:50%" },
...
export default {
  ...
  data: () => ({
    ...
    options: {
      ...
      payment_types: [
        { value: "", label: "Choose Payment Type", disabled: true, selected: "" },
