          ...
          <CRow>
            ...
            <CCol sm="6" md="4" class="pt-2">
              ...
              <div v-if="$v.form.dated.$error">
                <p v-if="!$v.form.dated.required" class="errorMsg">Date is required</p>
              </div>
            </CCol>
            <CCol sm="6" md="4" class="pt-2">
              <CInput
...
export default {
  ...
  methods: {
    ...
    resetForm() {
      ...
      this.sales_persons = [];
      this.display_images = [];
      this.previousValueCustomer = {};
      this.previousSalesPersons = [];
    },
  },
};
</script>
