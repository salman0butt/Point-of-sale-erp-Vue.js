            ...
            <CTabs add-tab-classes="mt-1">
              <CTab active>
                ...
                <CCardBody>
                     ...
                     <CButton block color="success" style="float:right;width: 100px;">Save</CButton>
                </CCardBody>
              </CTab>
              <CTab >
                <template slot="title">
                ...
                <CCardBody>                  
                    ...
                    <CCardBody v-for="(item, index) in timelst" :key="item.date">
                        ...
                        <CCol sm="6" md="3" class="pt-2">
                            <CSwitch class="mx-1"   color="success" :checked="item.status" shape="pill" />
                        </CCol>  
                        <CCol sm="6" md="2" class="pt-2">
                            <CInput
                                type="time"      
                        ...
                        <CCol sm="6" md="2" class="pt-2">
                            <CButton block color="default" @click="Addtiming(index,form[item.day+'from'],form[item.day+'to'])" style="width: 39px;border-radius:35px;margin:auto;"><CIcon name="cil-plus"/></CButton> 
                        </CCol>             
                        </CRow>
                        <CRow v-for="(item, index) in item.time" :key="item.from">
                            ...
                            <CCol sm="6" md="2" class="pt-2">
                                <CButton block color="default" style="width: 39px;border-radius:35px;margin:auto;" @click="DelTiming(item.id,index)"><CIcon name="cil-minus"/></CButton> 
                            </CCol>             
                        </CRow>
                    </CCardBody>                    
                    <CButton block color="success" style="float:right;width: 100px;margin-top:25px">Save</CButton>
                </CCardBody>
              </CTab>
              <CTab>
                <template slot="title">
                ...
                <CCardBody>
                    <CRow>
                        ...
                        <CCol sm="6" md="3" class="pt-2">
                            <CInput
                                label="Amount"
                                v-model="mediaitem.amount"                               
                            />                           
                        </CCol> 
                        <CCol sm="6" md="1" class="pt-2">
                            <CButton block color="default" @click="AddMedia" style="width: 39px;border-radius:35px;margin:auto;margin-top:25px"><CIcon name="cil-plus"/></CButton> 
                        </CCol>             
                    </CRow>
                    <CRow v-for="(item, index) in mediaLst" :key="item.channel">
                        ...
                        <CCol sm="6" md="1" class="pt-2">
                            <CButton block color="default" style="width: 39px;border-radius:35px;margin:auto;" @click="DelMedia(index)"><CIcon name="cil-minus"/></CButton> 
                        </CCol>             
                    </CRow>
                    <CButton block color="success" style="float:right;width: 100px;margin-top:25px">Save</CButton>
                </CCardBody>
...
export default {
  ...
  methods:{
        ...
        AddMedia(){
            if(this.mediaitem.channel == '' || this.mediaitem.name == '' || this.mediaitem.amount == ''){
                return false
            }
            var data = {channel:this.mediaitem.channel,name:this.mediaitem.name,amount:this.mediaitem.amount}
