        ...
        <CCard>
          <CCardBody>
            <CNav vertical="lg" pills>
              ...
              >
              <CNavItem active class="bborder">Detail</CNavItem>
              <CNavItem class="bborder">Salary</CNavItem>
              <CNavItem class="bborder">Awards</CNavItem>
              <CNavItem class="bborder">Contracts</CNavItem>
              <CNavItem class="bborder">Salary</CNavItem>
              <CNavItem class="bborder">Expense</CNavItem>
              <CNavItem class="bborder">Loans</CNavItem>
              <CNavItem class="bborder">Qualifications</CNavItem>
              <CNavItem class="bborder">Targets</CNavItem>
            </CNav>
          </CCardBody>
        </CCard>
      </CCol>
