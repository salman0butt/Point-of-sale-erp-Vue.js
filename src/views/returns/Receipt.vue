            ...
            <CRow>
              <CCol lg="4" sm="5" class="ml-auto">
                <table class="table table-clear">
                  <tbody>
                    <tr v-if="payment.product_return">
                      <td class="left">
                        <strong>Total Amount</strong>
                      </td>
                      <td class="right">
                        {{ payment.product_return.total_price }}
                      </td>
                    </tr>
  ...
  methods: {
    ...
    async getServerData() {
      ...
      await new Promise((resolve, reject) => {
        ...
        ProductReturnPaymentService.get(this.uuid)
          .then(({ data }) => {
            this.payment = data;
            this.branch = data.product_return.branch;
            // if (
            //   data.customer &&
