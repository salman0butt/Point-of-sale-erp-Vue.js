              ...
              <table class="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th
                      class="center"
                      v-if="payment.product_exchange && payment.product_exchange.invoice"
                    >
                      Invoice#
                    </th>
                    <th
                      class="center"
                      v-if="payment.product_exchange && payment.product_exchange.customer"
                    >
                      Customer
                    </th>
                ...
                <tbody>
                  <tr>
                    ...
                    >
                      {{
                        payment.product_exchange && payment.product_exchange.invoice
                          ? payment.product_exchange.invoice.invoice_ref_no
                          : "-"
                      }}
                    </td>
                    <td
                    ...
                    >
                      {{
                        payment.product_exchange && payment.product_exchange.customer
                          ? payment.product_exchange.customer.full_name
                          : "-"
                      }}
                    </td>
...
//TODO: Setup Recipt page for exchange
export default {
  ...
  methods: {
    ...
    async getServerData() {
      ...
      await new Promise((resolve, reject) => {
        ...
        ProductExchangePaymentService.get(this.uuid)
          .then(({ data }) => {
            this.payment = data;
            this.branch = data.product_exchange.branch;
            // if (
            //   data.customer &&
