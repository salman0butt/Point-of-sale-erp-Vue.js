<template>
  <CCard>
    <CCardHeader @click="line8()">
      <slot name="header">
        <CIcon name="cil-grid"/>Line No:8  {{description}}
      </slot>
    </CCardHeader>    
    <CCardBody>
      <CCard>
...
export default {
  ...
  async appData(){
    ...
    this.effective = Number((geteffective/this.DataList8.length).toFixed(2))
