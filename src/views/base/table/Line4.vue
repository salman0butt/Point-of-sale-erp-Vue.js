<template>
  <CCard>
    <CCardHeader @click="line4()">
      <slot name="header">
        <CIcon name="cil-grid"/>Line No:4  {{description}}
      </slot>
    </CCardHeader>    
    <CCardBody>
      <CCard>
...
export default {
  ...
  async appData(){
    ...
    this.effective = Number((geteffective/this.DataList4.length).toFixed(2))
