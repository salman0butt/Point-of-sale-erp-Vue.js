<template>
  <CCard>
    <CCardHeader @click="line3()">
      <slot name="header">
        <CIcon name="cil-grid"/>Line No:3  {{description}}
      </slot>
    </CCardHeader>    
    <CCardBody>
      <CCard>
...
export default {
  ...
  async appData(){
    ...
    this.effective = Number((geteffective/this.DataList3.length).toFixed(2))
