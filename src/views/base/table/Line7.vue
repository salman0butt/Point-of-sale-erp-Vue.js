<template>
  <CCard>
    <CCardHeader @click="line7()">
      <slot name="header">
        <CIcon name="cil-grid"/>Line No:7  {{description}}
      </slot>
    </CCardHeader>    
    <CCardBody>
      <CCard>
      ...
      >
        ...
        <template #Machine="{item}" >
          <td @click="SelJob(item.machine_id)" style="text-align:center">
            {{item.machine_id}}
          </td>
        </template>
      </CDataTable>
...
export default {
  ...
  async appData(){
    ...
    this.effective = Number((geteffective/this.DataList7.length).toFixed(2))
    ...
    SelJob(val){                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
        for(var i = 0; i < this.DataList.length ;i++){
         if(val == line[i].Machine){
            this.SelNPP = line[i].NPP      
            break;            
         }
        }
      if(this.SelNPP == ""){
        this.$router.push("/jobcreate/"+val)
      }else{
        return
      }
    }
